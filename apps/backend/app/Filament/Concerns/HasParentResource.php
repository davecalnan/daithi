...
trait HasParentResource
{
    ...
    public static function getParentResource(): string
    {
        ...
        if (! isset($parentResource)) {
            throw new LogicException('Parent resource is not set for '.static::class);
        }
    ...
    public function getBreadcrumbs(): array
    {
        ...
        $breadcrumbs = [
            ...
            $parentResource::getUrl(name: 'show', parameters: ['record' => $this->parent]) => $parentResource::getRecordTitle($this->parent),
